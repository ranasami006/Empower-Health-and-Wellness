...
export default class Question20 extends Component {
    ...
    onPress = async (value) => {
        try {
            ...
            await AsyncStorage.setItem('Question20', value)
           //console.log("OKOIII",value)
           this.props.navigation.navigate("Question21")
          } catch (e) {
            // saving error
          }
      };
        ...
        return (
            <View
                ...
                <View style={styles.textbuttonView}>
                    <Text style={styles.textbutton}>Is it common for you to consume one or more alcoholic beverages at the end of day? </Text>
                </View>
                ...
                <View style={styles.buttonView}>
                    <View style={styles.buttonView1}>
                        ...
                        <TouchableOpacity
                            ...
                            onPress={()=>this.onPress("0")}
                        >
                            <Text style={styles.textbutton1}> Hell yes</Text>
                        </TouchableOpacity>
                    </View>
                    ...
                    <View style={styles.buttonView1}>
                        ...
                        >
                            <Text style={styles.textbutton1}> Occasionally</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                            style={[styles.button, { marginLeft: 20 }]}
